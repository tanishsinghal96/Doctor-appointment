          ...
          >
            ...
            <div className="flex flex-col gap-2 mt-4 md:mt-0">
              ...
              {doctor.isCompleted ? (
                ...
                <span className="text-blue-600 font-semibold text-center">Active</span>
              )}
              {(doctor.cancelled === false && doctor.isCompleted === false) && <button className="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-600 transition" onClick={() => cancelHandler(doctor._id)}>
                Cancel appointment
              </button>}
